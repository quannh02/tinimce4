<?php
/**
 * Copyright © Quan (support@magefan.com). All rights reserved.
 * See LICENSE.txt for license details (http://opensource.org/licenses/osl-3.0.php).
 */
namespace Quan\TinyMce\Plugin\Magento\Ui\Component\Wysiwyg;
...
class ConfigPlugin
{
    ...
    public function afterGetConfig(
        ...
        if (strpos($editor, 'tinymce4Adapter')) {
            ...
            $settings['fontsize_formats'] = '8pt 10pt 11pt 12pt 13pt 14pt 16pt 18pt 20pt 24pt 26pt 36pt 72pt';
